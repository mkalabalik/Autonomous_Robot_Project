        ...
        if len(cnts) > 0:
            ...
            if ((radius > 10) and (radius < 210)):
                ...
                if(int(x) < (319-midpoint)):
                    cv2.putText(frame,"sola don", (center[0]+10,center[1]), cv2.FONT_HERSHEY_SIMPLEX, 2,(0, 0, 255),1)
                    robot.solaDon()
                    #sleep(0.1)
                    #robot.dur()
                elif(int(x) > (319+midpoint)): 
                    cv2.putText(frame,"saga don", (center[0]+10,center[1]), cv2.FONT_HERSHEY_SIMPLEX, 2,(0, 0, 255),1)    
                    robot.sagaDon()
                    #sleep(0.1)
                    #robot.dur()
                else:
                    ...
                    #sleep(0.1)
                    #robot.dur()
                    cv2.putText(frame,"ilerle", (center[0]+10,center[1]), cv2.FONT_HERSHEY_SIMPLEX, 2,(0, 0, 255),1)  
