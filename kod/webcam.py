...
def gripperAc():
    ...
    pwm.set_pwm(servoGripperPin, 0, gripperMax)
    sleep(1.5)
    return

def koluIndir():
    print("kol indiriliyor")
    pwm.set_pwm(servoIleriPin, 0, ileriMax)
    pwm.set_pwm(servoYukariPin, 0, yukariMin)
    sleep(1.5)
    return
    
def gripperKapa():
    print("Gripper kapaniyor")
    pwm.set_pwm(servoGripperPin, 0, gripperMin)
    sleep(0.5)
    return

def koluKaldir():
    print("kol kaldiriliyor")
    pwm.set_pwm(servoIleriPin, 0, ileriMin)
    pwm.set_pwm(servoYukariPin, 0, yukariMax)
    sleep(1.5)
    return
